...
<div id="wrapper">
    ...
    <nav class="top1 navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="index.html">MOOCStatistic</a>
        </div>
        <!-- /.navbar-header -->
    ...
    <div id="page-wrapper">
        <div class="graphs">
            ...
            <div class="copy_layout">
                <p>Copyright &copy; 2018.Company name All rights reserved.<!-- <a target="_blank" href="http://0lddriv3r.github.io/">教授</a> --></p>
            </div>
        </div>
    </div>
    <!-- /#page-wrapper -->

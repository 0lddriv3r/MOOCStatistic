...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        ...
        <div align="left" style=font-size:14px >欢迎您进入“证书预测”，我们会根据您近期的学习情况进行分析，得出一个如果您继续按照当前的学习行为进行学习，是否能顺利通过此门课程并最终得到证书的结果。</div>
        <div align="center"><button class="center-block" onclick="predict()">点击预测</button></div>
        <div align="left" style=font-size:14px >输出结果为“0”则说明：对不起，以您目前的学习行为，您不能通过课程考核，无法获得证书。<br>请根据本系统的其他相关分析，及时调整自己的学习方法和状态，提升自身学习能力。<br>输出结果为“1”，则说明：根据此学生目前的学习行为分析，其可以顺利通过课程考核，获得证书。</div>
        <div class="graphs">
...
<script type="text/javascript">
    function predict() {
        ...
        $.ajax({
            type: "get",
            async: false,
            url: "http://123.206.205.246:8080/mooc/work/sp.do",
            dataType : "jsonp",
            jsonp : "callback",
            jsonpCallback : "jsonpCallback",
            success: function (result) {
                if (result) {
                    var str_head = "<tr><th>证书获取情况</th></tr>";
                    thead.innerHTML = str_head;

                    var str_body = "";
                    for (var i = 0; i < result.result.length; i++) {
                        str_body += "<tr><td>" + result.result[i] + "</td></tr>";
                    }

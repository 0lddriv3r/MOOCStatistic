...
<body>
<%--<jsp:useBean id="user" class="UserTable.UserTable"></jsp:useBean>--%>
<%--<jsp:setProperty property="*" name="user"/>--%>
<h1 class="w3ls">MOOC Signon</h1>
	<div class="content-agileits">
		<form id="loginForm" action="/LoginServlet" method="post" role="form">
			<div class="form-group w3l agileinfo wthree w3-agileits">
				<label for="inputEmail" class="control-label">Username</label>
				<input type="email" class="form-control" id="inputEmail" name="inputEmail" placeholder="Email" data-error="This email address is invalid" required>
			...
			<div class="form-group w3l agileinfo wthree w3-agileits">
				...
				<input type="password" class="form-control" id="inputPassword" name="inputPassword" data-match="#inputPassword" data-match-error="Password don't match" placeholder="Password" required>
				<div class="help-block with-errors"></div>
			</div>
			...
			<div class="form-group">
				<button onclick="location='signup.jsp'" type="button" class="btn btn-lg">Signup</button>
			</div>
		</form>
    </div>

...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div align="center"><h1>欢迎进入教师课程分析系统</h1></div>
        <div class="graphs">
...
<script type="text/javascript">
    ...
    var tbody=window.document.getElementById("tbody-result");
         ...
         type : "get",
         async : false,
         url : "http://123.206.205.246:8080/mooc/work/cList.do",
         dataType : "jsonp",
         jsonp : "callback",
         ...
         success : function(result) {
             ...
             if (result) {
                 var str_head = "<tr><th>序号</th><th>课程ID</th><th>选课人数</th><th>获得证书人数</th></tr>";
                 thead.innerHTML = str_head;

                 var str_body = "<tr><td>1</td><td>";

                 str_body += result.cid[0];
                 str_body += "</td><td>";
                 str_body += result.all[0];
                 str_body += "</td><td>";
                 str_body += result.certified[0];

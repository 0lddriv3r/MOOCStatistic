...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div align="center"><h1>欢迎进入学生课程分析系统</h1></div>
        <div class="graphs">
            <div id="main" style="width: 100%;height: 700px;;">
                ...
                <table class="table table-striped" id="table-result2">
                    <thead id="thead-result2">
                    </thead>
...
<script type="text/javascript">
    ...
    var thead2=window.document.getElementById("thead-result2");
    var tbody2=window.document.getElementById("tbody-result2");
    $.ajax({
         type : "GET",
         async : false,
         url : "http://123.206.205.246:8080/mooc/user/getStudent.do",
         dataType : "jsonp",
         jsonp : "callback",
         ...
         success : function(result) {
             if (result) {
                 var str_head = "<tr>";
                 for (var i=0; i < result.names.length/2; i++) {
                     str_head += "<th>" + result.names[i] + "</th>";
                 }
                 str_head += "</tr>";
                 thead.innerHTML = str_head;

                 var str_body = "<tr>";
                 for (var i=0; i < result.values.length/2; i++) {
                     str_body += "<td>" + result.values[i] + "</td>";
                 }
                 str_body += "</tr>";
                 tbody.innerHTML = str_body;

                 var str_head2 = "<tr>";
                 for (var i=result.names.length/2; i < result.names.length; i++) {
                     str_head2 += "<th>" + result.names[i] + "</th>";
                 }
                 str_head2 += "</tr>";
                 thead2.innerHTML = str_head2;

                 var str_body2 = "<tr>";
                 for (var i=result.values.length/2; i < result.values.length; i++) {
                     str_body2 += "<td>" + result.values[i] + "</td>";
                 }
                 str_body2 += "</tr>";
                 tbody2.innerHTML = str_body2;
             }
